...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (empty($name)) {
        ...
        if ($stmt->execute()) {
            // Email notification logic using PHPMailer
            $cmail = new PHPMailer(true);
            try {
                $cmail->isSMTP();
                $cmail->Host = 'sandbox.smtp.mailtrap.io';
                $cmail->SMTPAuth = true;
                $cmail->Username = 'your_username';
                $cmail->Password = 'your_password';
                $cmail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
                $cmail->Port = 587;

                $cmail->setFrom('info@rosejadeinc.com', 'Rose Jade Inc');
                $cmail->addAddress('anisha@gmail.com');
                $cmail->Subject = 'New Message from Contact Form';
                $cmail->Body = "Name: $name\nEmail: $email\nMessage: $message";

                if ($cmail->send()) {
                    $response['status'] = 'success';
                    $response['message'] = 'Message sent successfully and data saved!';
                } else {
                    $response['status'] = 'error';
                    $response['message'] = 'Message not sent, but data saved.';
                }
            } catch (Exception $e) {
                $response['status'] = 'error';
                $response['message'] = "Mailer Error: {$cmail->ErrorInfo}";
            }
        } else {
            $response['status'] = 'error';
            $response['message'] = 'Failed to save data in the database.';
        }
    ...
    // Clear any prior output and send JSON response
    ob_end_clean();
...
<main>
    ...
    <section class="banner__inner-page bg-image pt-180 pb-180 bg-image"
        data-background="assets/images/banner/contact-us.png">
        ...
        <div class="container">
            ...
            <div class="breadcrumb-list wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                <a href="index.php">Home</a><span><i class="fa-regular fa-angles-right mx-2"></i>Contact Us</span>
            </div>
        </div>
    </section>
    ...
    <section class="contact-area pt-120 pb-120">
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-5">
                    <div class="contact__left-item primary-bg text-justify">
                        <h3 class="text-white mb-30">Contact Information</h3>
                        <p class="text-white">Ready to take your business to the next level? Contact Rose Jade Inc.
                            today for flexible and transparent funding solutions tailored to your needs. Whether you’re
                            looking for immediate funding through our Merchant Cash Advance, a flexible Line of Credit,
                            or essential Equipment Financing, we’re here to help your business thrive.</p>
                        <ul class="mt-40 mb-40">
                            <li>
                                ...
                                <div>
                                    ...
                                    <h5 class="mt-1"><a class="text-white" href="tel:(555) 123-4567">(555) 123-4567</a>
                                    </h5>
                                </div>
                            </li>
                            <li>
                                ...
                                <div>
                                    ...
                                    <h5 class="mt-1"><a class="text-white" href="#0">info@rosejadeinc.com</a>
                                    </h5>
                                </div>
                            </li>
                            <li>
                                ...
                                <div>
                                    ...
                                    <h5 class="mt-1"><a class="text-white"
                                            href="https://www.google.com/maps?q=86A+N+Mada+Ave,+Staten+Island,+NY+10310,+USA"
                                            target="_blank" rel="noopener noreferrer">86A N Mada Ave,
                                            <br /> Staten Island,NY 10310, USA</a>
                                    </h5>
                                </div>
                            </li>
                        </ul>
                ...
                <div class="col-lg-6">
                    <div class="contact__right-item">
                        <div class="section-header mb-20 text-justify">
                            ...
                            <h3 class="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">Ready to Get
                                Started?</h3>
                            <p class="wow fadeInUp mt-3" data-wow-delay="400ms" data-wow-duration="1500ms">Our expert
                                team is dedicated to guiding you every step of the way, ensuring you get the right
                                financial solution to fuel your business growth. With a simple and straightforward
                                process, we make accessing the funds you need fast and hassle-free.</p>
                        </div>
                        <div class="contact__form">
                            <form id="contactForm">
                                <div class="row">
                                    <div id="response" class="mt-20"></div>
                                    <div class="col-6">
                                        <label for="name">Your Name*</label>
                                        <input id="name" name="name" class="bg-transparent bor" type="text"
                                            placeholder="Your Name">
                                        <div class="error" id="nameError"></div>
                                    </div>
                                    <div class="col-6">
                                        <label for="email">Your Email*</label>
                                        <input class="bg-transparent bor" id="email" type="email" name="email"
                                ...
                                <div class="btn-two">
                                    ...
                                    <button type="Submit" class="btn-one">Send Message <i
