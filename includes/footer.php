                ...
                <div class="footer__wrp pt-100 pb-100">
                    ...
                    <div class="footer__item item-sm wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                        ...
                        <ul class="quick-link" style="padding-bottom:45px;">
                            <li><a href="index.php"><i class="fa-regular fa-angles-right me-1"></i>
                                    Home </a></li>
                            <li><a href="about.php"><i class="fa-regular fa-angles-right me-1"></i>About
                                    Us</a>
                            </li>
                            <li><a href="contact.php"><i class="fa-regular fa-angles-right me-1"></i>
                                    Contact Us</a>
                            </li>
                            <!-- <li><a href="case.php"><i class="fa-regular fa-angles-right me-1"></i> Our Projects</a></li>
                        <li><a href="team.php"><i class="fa-regular fa-angles-right me-1"></i> Our Team</a></li> -->
                        </ul>
                    </div>
                    <div class="footer__item item-sm2 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                    ...
                    <div class="footer__item item-big wow fadeInUp text-justify" data-wow-delay="600ms" data-wow-duration="1500ms">
                        ...
                        <p class="mb-20 mr-25">We will inform you about promotions and exclusive offers as well as new
